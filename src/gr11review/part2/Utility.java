...
public class Utility {
    ...
    /**
     * Sorts a text file with multiple words on separate lines, returns the word
    ...
    /**
     * Given an array, return a version where every instance of the given value
     ...
     * @return value by replacing it with whichever value to its left or right is
     *         larger
     * @author A. Chan
     */
    public static int[] notAlone(int[] nums, int value) {
        ...
        for (int i = 1; i < nums.length - 1; i++) {
            ...
            // check if array index is equal to specified value, and that the values before
            // and after are not the same value
    ...
    /**
     * Inverts a 2D array (each row of the 2D array is now a column, and each column
     * is now a row)
     * 
    ...
    /**
     * Given one string, find the sum of all characters that are listed as numbers
     * (ex: '1'.'3')
     *
    ...
    /**
     * Given a file, check each word per line and to see which word has the most
     * vowels
     *
    ...
    public static String vowelCount(String filenametxt) throws IOException {
        ...
        while (line != null) {
            ...
            for (int i = 0; i < currentWord.length(); i++) {
                ...
                if (currentWord.charAt(i) == 'a' || currentWord.charAt(i) == 'e' || currentWord.charAt(i) == 'i'
                        || currentWord.charAt(i) == 'o' || currentWord.charAt(i) == 'u') {
    ...
    /**
     * Given two arrays, check to see if the ints in the inner array are in the
     * outer array
     *
     * @param outer The first array
     * @param inner The second array
     * @return true if ints in the inner array are in the outer array or false if
     *         they aren't
     * @author A. Young
     */
    ...
    public static int[][] reverse(int[][] arr) {
        ...
        for (int row = 0; row < arr.length; row++) {
            ...
            for (int col = 0; col < arr[0].length; col++) {
                numberCol--;
                // Building a new 2D array by using values which are reversed from the first
                // array
    ...
    /**
     * Given a string determine if all x's have at least one y coming after them in
     * the string
     * 
    ...
    public static String longestWord(String filenametxt) throws IOException {
        ...
        // Initialized buffered reader and set a string equal to the first line in theh
        // file
        BufferedReader reader = new BufferedReader(new FileReader(filenametxt));
        String line = reader.readLine();
    ...
    /**
     * Given an array replace all '10s' with 0s at the end of the array and move all
     * non-ten elements to the beginning
     * 
    ...
    /**
     * Given an 2d array, return an array with elements up to a certain row and
     * column of the original 2d array
     * 
